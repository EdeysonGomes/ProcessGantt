...
Public Class PrioridadePreemptivo
    Implements IAlgoritmo
    Dim locAtributos As New Atributos
    Dim locDescricao As String = "Prioridade Preemptivo"
        ...
        Do While FilaDeInicio.Count > 0 Or FilaPronto.Count > 0 Or Not IsNothing(ProcessoEmExecucao)
            ...
            While FilaDeInicio.ProcessosPendentes(locTimerInterno.Instante)
                ...
                If Not IsNothing(ProcessoEmExecucao) Then
                    ...
                    If ProcessoEmExecucao.Prioridade > ObterMaiorPriotidade(FilaPronto) Then
                        With ProcessoEmExecucao
                            Ret.Add(New Processo(.id, .Inicio, locTimerInterno.Instante - .Inicio, .Prioridade))
                        End With
    ...
    'Só PrioridadePreemptivo.vb
    Public Function ObterMaiorPriotidade(ByVal filaPronto As FilaDeProcessos) As Integer
